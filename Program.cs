...
void CreateNewPlant()
{
    ...
    {
        Console.WriteLine("Please pick a valid input!");
    }
...
{
    string plantDetail = $"A {plant.Species} in {plant.City} {(plant.Sold ? "was sold" : "is available")} for {plant.AskingPrice} dollars";
    return plantDetail;
}
Console.ReadLine();